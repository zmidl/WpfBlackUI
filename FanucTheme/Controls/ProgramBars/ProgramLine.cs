...
{
   public class ProgramLine : ProgramBase
   {
      ...
      private new Ellipse CreateEllipse()
      {
         var ellipse = base.CreateEllipse();
         ellipse.HorizontalAlignment = HorizontalAlignment.Left;
         ellipse.VerticalAlignment = VerticalAlignment.Top;
         ellipse.Margin = new Thickness(-(DotInterval + DotDiameter), 0, 0, 0);
         return ellipse;
      }
   }
}
