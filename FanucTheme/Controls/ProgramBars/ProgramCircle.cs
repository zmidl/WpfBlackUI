   ...
   public class ProgramCircle : ProgramBase
    {
        ...
        public static readonly DependencyProperty NeedHiddenProperty = DependencyProperty.Register(
            "NeedHidden", typeof(bool), typeof(ProgramCircle),
        ...
        static ProgramCircle()
        {
            DotSpeedProperty.OverrideMetadata(typeof(ProgramCircle),
                new FrameworkPropertyMetadata(6.0, FrameworkPropertyMetadataOptions.AffectsRender));
            DotDelayTimeProperty.OverrideMetadata(typeof(ProgramCircle),
